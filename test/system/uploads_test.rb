...
class UploadsTest < ApplicationSystemTestCase
  ...
  test "should create upload" do
    ...
    fill_in "Current location", with: @upload.current_location
    fill_in "Fuel type", with: @upload.fuel_type
    fill_in "Petroleum company name", with: @upload.petroleum_company_name
    fill_in "Station", with: @upload.station_id
